...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            options=[{'label': j, 'value': j} for j in dropdown_options],
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(values='Advertising_Expenditure', labels='Vehicle_Type', title='Total Advertisment Expenditure for Each Vehicle'))
